<nav class="navbar navbar-expand-lg navbar-filters mb-0 p-0 py-2 rounded shadow-sm">
      <!-- Brand and toggle get grouped for better mobile display -->
      <a class="nav-item d-none d-lg-block pl-3"><span class="la la-filter"></span></a>
      ...
      <div class="collapse navbar-collapse" id="bp-filters-navbar">
        <ul class="nav navbar-nav px-md-3">
          <!-- THE ACTUAL FILTERS -->
